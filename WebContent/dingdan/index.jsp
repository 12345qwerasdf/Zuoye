...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment id="myForm" action=dingdan/alipay.trade.page.pay.jsp method=post
			target="_blank">
				...
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" id="myForm" type="submit"
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDtotal_amount").value = "${totalmoney}";
